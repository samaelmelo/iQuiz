...
let questoes: [Questao] = [
    Questao(titulo: "Qual feitiço para desarmar o seu oponente, em Harry Potter", respostas: ["Expect Patronum", "Avada Redava", "Expelliarmus"], respostaCorreta: 2),
    Questao(titulo: "Quando foi lançado o filme Vingadores Ultima", respostas: ["2019", "2018", "2017"], respostaCorreta: 0),
    Questao(titulo: "Quando foi lançado o file Avatar 2", respostas: ["2014", "2022", "2023"], respostaCorreta: 1),
